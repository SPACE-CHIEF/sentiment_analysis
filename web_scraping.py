...
class Init():
    ...
    def __init__(self):
        ...
        self.start_date = "2021-03-24"
        self.end_date = "2022-03-25"
        self.tickers = get_tickers()

        self.db_name = 'financial_data'
        self.dir_path = os.path.dirname(os.path.realpath(__file__)) + '/webscrape_headlines/output/' + self.start_date + '_' + \
                        self.end_date + '/'
